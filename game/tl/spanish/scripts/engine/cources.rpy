...
translate spanish strings:
    ...
    new "Habilidades de comunicación: sentimientos humanos"
    ...
    new "Se trata de un curso básico de habilidades de comunicación y contiene información básica sobre los sentidos, cómo reacciona la gente a tus palabras y los fundamentos del lenguaje corporal."
