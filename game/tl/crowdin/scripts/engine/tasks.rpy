...
translate crowdin strings:
    ...
    new "Возможность просматривать вэб-трансляции с Алисой!"
    ...
    new "Нужно, чтобы Алиса несколько раз заметила, как я подглядываю за ней в душе..."
