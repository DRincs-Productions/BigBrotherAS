...
translate french talks_start_41e41361:
    ...
    Alice 00 "Allez, Max, qu'est-ce que tu veux ?" nointeract

# game/scripts/engine/interact.rpy:37
translate french talks_start_8c1733ca:

    # Alice 00 "Что у тебя, Макс, выкладывай?" nointeract
    Alice 00 "Qu'est-ce que tu as, Max, crache le morceau ?" nointeract

# game/scripts/engine/interact.rpy:40
translate french talks_start_7461055d:

    # Ann 00 "Что-то случилось, дорогой?" nointeract
    Ann 00 "Quelque chose ne va pas, ma chérie ?" nointeract

# game/scripts/engine/interact.rpy:42
translate french talks_start_cfefc888:

    # Ann 00 "Ты что-то хотел, сынок?" nointeract
    Ann 00 "Tu veux quelque chose, fiston ?" nointeract

# game/scripts/engine/interact.rpy:45
translate french talks_start_3d07e87c:

    # Lisa 00 "Макс, решил поболтать?" nointeract
    Lisa 00 "Max, tu veux discuter ?" nointeract

# game/scripts/engine/interact.rpy:47
translate french talks_start_6f4298c9:
...
translate french dirty_max_0a097abd:
    ...
    Lisa 12 "Oh, Max, ew ! Tu ne te douches jamais ? Ne t'approche même pas de moi." nointeract

translate french strings:

    # game/scripts/engine/interact.rpy:19
    old "Нет, мам. Ничего. ({i}уйти{/i})"
    new "Non, maman. Rien. ({i}go away{/i})"

    # game/scripts/engine/interact.rpy:21
    old "Нет. Я так, просто... ({i}уйти{/i})"
    new "Non. Je dis juste... ({i}leave{/i})"
