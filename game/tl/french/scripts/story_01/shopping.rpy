...
translate french ev_051_f2e28c50:
    ...
    Ann 01 "Max, on va faire du shopping. Ne t'ennuie pas ici sans nous, d'accord ? Nous serons de retour dans environ trois heures." nointeract

# game/scripts/story_01/shopping.rpy:16
translate french ev_051_4369a813:
...
translate french ev_052_7fac4255:
    ...
    Max 01 "Oui, c'est ça. D'accord, reposez-vous."

translate french strings:

    # game/scripts/story_01/shopping.rpy:9
    old "Удачных вам покупок... \n{i}(остаться дома){/i}"
    new "Amusez-vous bien en faisant du shopping... \n{i}(rester à la maison){/i}"

    # game/scripts/story_01/shopping.rpy:9
    old "Подождите! Я с вами..."
    new "Attendez ! Je suis avec vous."
