...
translate italian ev_029_47925c16:
    ...
    Max 00 "È ora di leggere...[nointeract]"

# game/scripts/story_01/max_learning.rpy:25
translate italian ev_029_manual_fd324daa:

    # Max 13 "Хм... куча непонятных слов. Кажется, нужно будет заново перечитать первые главы..."
    Max 13 "Hm... Un sacco di parole incomprensibili. Credo che dovrò rileggere i primi capitoli..."

# game/scripts/story_01/max_learning.rpy:28
translate italian ev_029_manual_41775a3a:

    # Max 12 "Так, ну с этим я уже разобрался, хорошо... А это что такое? Не ясно. Нужно будет всё осмыслить..."
    Max 12 "Bene, ho risolto la questione, ok... Cos'è questo? Non è chiaro. Dovrò capirlo..."

# game/scripts/story_01/max_learning.rpy:31
translate italian ev_029_manual_b8327ffa:

    # Max 11 "Ого, вот это здорово! Уже можно делать сайт? А, нет... Ещё не всё понятно... Ну, разберусь в другой раз."
    Max 11 "Wow, è fantastico! È possibile creare un sito web? Ah, no... Non lo so ancora... Beh, ci penserò un'altra volta."

# game/scripts/story_01/max_learning.rpy:34
translate italian ev_029_manual_90d4232e:

    # Max 12 "Так, ну теперь картина вырисовывается. Осталось разобраться только с мелочами... Или это не мелочи?"
    Max 12 "Bene, il quadro si sta delineando. Restano solo le piccole cose da sistemare... O non sono le piccole cose?"

# game/scripts/story_01/max_learning.rpy:37
translate italian ev_029_manual_7b71f292:
    ...
    Max 01 "Ecco, ora tutto ha perfettamente senso! Posso già creare il mio sito web e trasmettervi un'immagine! Ma come faccio a guadagnare? Oh, no, anche questo ha senso!"

# game/scripts/story_01/max_learning.rpy:52
translate italian ev_029_sex_ed_994a9243:
    ...
    Max 11 "Già... Ognuno ha le sue peculiarità, o non lo sapevo! Ecco, la struttura dei genitali di un'adolescente, ecco di cosa si tratta... Leggiamo e guardiamo!"

# game/scripts/story_01/max_learning.rpy:56
translate italian ev_029_sex_ed_14d7ce4b:
    ...
    Max 13 "Ok, questo non è molto interessante. Ma il comportamento sessuale degli adolescenti è il mio. Se potessi scrivere anche delle mie erezioni mattutine, sarebbe fantastico..."

# game/scripts/story_01/max_learning.rpy:59
translate italian ev_029_sex_ed_fc26c8c4:
    ...
    Max 12 "Wow! C'è anche un breve schizzo storico sull'educazione sessuale dei bambini e degli adolescenti.... Che modo di incasinare le loro teste per tutto questo tempo!"

# game/scripts/story_01/max_learning.rpy:62
translate italian ev_029_sex_ed_9fd6eafe:

    # Max 11 "Вот и последние главы... Как я понял, очень важны прикосновения. Причём, всегда! А реакция на них может о многом сказать..."
    Max 11 "Ecco gli ultimi capitoli... Come ho capito, il tatto è molto importante. Sempre! E la reazione ad essi può dire molto..."

# game/scripts/story_01/max_learning.rpy:67
translate italian ev_029_sex_ed_85dd3cb6:
    ...
    Max 01 "Meno male che ho letto questo libro prima d'insegnare a mia sorellina la saggezza della vita adulta! Probabilmente mi sarei messo in imbarazzo per niente... Ora che ho imparato il libro, posso darlo a Lisa."

# game/scripts/story_01/max_learning.rpy:71
translate italian ev_029_sex_ed_21b1eb2c:
    ...
    Max 12 "Avrei dovuto leggere prima questo libro e poi insegnare a mia sorella la saggezza della vita adulta. Mi sono messo in imbarazzo per niente! Ora non posso far altro che cercare di sistemare le cose. Se, ovviamente, ci riesco..."

# game/scripts/story_01/max_learning.rpy:97
translate italian ev_046_14fb5a6a:

    # Max 01 "Хм... мне кажется такое можно и лёжа на кровати изучать, но лучше останусь за столом, а то ещё Лизу разбужу..."
    Max 01 "Mmm... Mi sembra che si possa studiare anche stando sdraiati sul letto, ma è meglio che rimanga seduto alla scrivania, altrimenti sveglierò Lisa..."

# game/scripts/story_01/max_learning.rpy:99
translate italian ev_046_23ca8fd9:

    # Max 01 "Хм... мне кажется такое можно и лёжа на кровати изучать. Надеюсь, меня не станет клонить в сон..."
    Max 01 "Ehm... Penso che si possa fare stando a letto. Spero di non addormentarmi..."

# game/scripts/story_01/max_learning.rpy:103
translate italian ev_046_66ef962f:

    # Max 11 "Хорошая штука эти онлайн-курсы. Можно научиться всему, не выходя из дома! Вот только и стоит это немало..."
    Max 11 "I corsi online sono un'ottima cosa. Si può imparare tutto comodamente da casa propria! Ma costa anche molto..."

# game/scripts/story_01/max_learning.rpy:107
translate italian ev_046_81dac6d3:
    ...
    Max 04 "Non posso dire che sia difficile, ma ci vuole molta conoscenza ed esperienza! E ora sono pronto a mettere in pratica ciò che ho imparato..."

# game/scripts/story_01/max_learning.rpy:118
translate italian ev_046_1c72ad2c:
    ...
    tMax 01 "E visto che è iniziato con Alice, inizierò a esercitarmi su di lei. Spero che non mi strappi le braccia se faccio qualcosa di sbagliato..."

# game/scripts/story_01/max_learning.rpy:133
translate italian ev_046_2c43168e:
    ...
    tMax 01 "Devo convincere Alice che spogliarsi in webcam non è poi così male. Potrebbe persino essere redditizio se lo facesse con un senso di..."

# game/scripts/story_01/max_learning.rpy:136
translate italian ev_046_66ef962f_1:
