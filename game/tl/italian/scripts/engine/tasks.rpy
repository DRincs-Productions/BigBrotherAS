...
translate italian strings:
    ...
    new "Ho trovato una telecamera nascosta nel soggiorno. È stata incassata nel muro, a quanto pare durante la ristrutturazione. Pertanto, non può essere rimossa senza danneggiarla. Inoltre, è emerso che la telecamera non è collegata a nulla al momento. Forse dovrei cercare dei modi per collegare la telecamera in modo da poterne ricavare qualcosa..."
    ...
    new "Finalmente ho il mio sito web con una telecamera in diretta dal mio salotto! Ora devo aumentare il mio pubblico, perché più gente c'è, più reddito c'è. \nE per aumentare il pubblico, è necessario che nell'inquadratura succeda qualcosa di interessante. La nostra casa è troppo grande per limitarci a una sola telecamera nascosta..."

    # game/scripts/engine/tasks.rpy:191
    old "Купить и установить скрытую камеру в ванную комнату."
    new "Compra e installa una telecamera nascosta nel bagno."

    # game/scripts/engine/tasks.rpy:191
    old "В следующих версиях..."
    new "Nelle versioni successive..."
    ...
    new "Alice ha parlato del suo blog e del problema della perdita degli oggetti durante il trasloco. Ora non ha nulla da mostrare, nulla da scrivere nel suo blog ed è triste. \nMa per poterla aiutare in qualche modo, dovrò prima procurarmi un po' di soldi..."
    ...
    new "Soccorritore senza scrupoli"
    ...
    new "Ancora una volta stavo guardando Alice che si faceva la doccia e lei mi notò. \nCercando di scusarmi, le ho promesso di comprarle dei dolci in cambio di non dirlo alla mamma. \nSorprendentemente, sono ancora vivo, ma non ho molto tempo..."
    ...
    new "L'opportunità di regalare ad Alice dei dolci di tanto in tanto per tirarla su di morale!"

    # game/scripts/engine/tasks.rpy:191
    old "Школьный секретик Лизы"
    new "Il segreto scolastico di Lisa"
    ...
    new "Parla con Lisa dell'incidente di stamattina."

    # game/scripts/engine/tasks.rpy:191
    old "Узнать, как Лиза отреагирует на мой следующий утренний стояк."
    new "Per vedere come avrebbe reagito Lisa alla mia erezione mattutina."

    # game/scripts/engine/tasks.rpy:191
    old "Рано или поздно Лиза снова наткнётся на моё «приподнятое» утреннее состояние. Нужно просто ждать..."
    new "Prima o poi, Lisa si imbatterà di nuovo nel mio stato mattutino «rinvigorito». Devo solo aspettare..."

    # game/scripts/engine/tasks.rpy:191
    old "Дождаться следующего утреннего стояка и реакции Лизы на него."
    new "In attesa dell'erezione del mattino successivo e della reazione di Lisa."
    ...
    new "Ho notato che il costume da bagno di Lisa è piuttosto chiuso, almeno sul davanti. Non è giusto che la pancia non si abbronzi affatto! Anche lei lo pensa, ma non ne ha altri. Gli altri sono andati persi con altre cose durante il trasloco. Forse posso fare qualcosa per aiutarla. Ma ho bisogno di soldi..."

    # game/scripts/engine/tasks.rpy:191
    old "КНУТ ИЛИ ПРЯНИК?"
    new "BASTONE O CAROTA?"
    ...
    new "Ho deciso di ammirare il seno di Lisa mentre dormiva e non è andata bene... Si è svegliata e ha iniziato subito a chiamare la mamma, ma per fortuna Lisa non ha potuto opporsi in alcun modo. \nSoprattutto, la mamma ci ha consigliato di affrontare i nostri conflitti da soli. Ora mi chiedo come fare a resistere a Lisa la prossima volta..."

    # game/scripts/engine/tasks.rpy:191
    old "Стянуть с Лизы одежду утром, пока она ещё спит."
    new "Togli i vestiti a Lisa la mattina mentre sta ancora dormendo."

    # game/scripts/engine/tasks.rpy:191
    old "Для этого нужно проснуться раньше Лизы и полюбоваться ею..."
    new "Per farlo, devi svegliarti prima di Lisa e ammirare la sua..."
    ...
    new "Ad Alice piace prendere il sole. Senza troppe speranze, ho proposto di metterle un po' di olio abbronzante, che né io né lei avevamo. \nMa non le importava! Quindi, tutto quello che devo fare è procurarmi un olio con protezione solare e andare avanti..."
    ...
    new "Alice sta leggendo una specie di libro, ma non vuole parlarne. Non sembra una rivista porno... Cos'altro potrebbe essere? \nDovremmo cercare di scoprirlo il prima possibile... Sono curioso!"
    ...
    new "Compra e regala ad Alice un romanzo erotico."
    ...
    new "Fai compagnia alla mamma guardando più spesso la TV."
