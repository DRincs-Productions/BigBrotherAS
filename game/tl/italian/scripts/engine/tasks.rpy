...
translate italian strings:
    ...
    new "Dare una sculacciata ad Alice mentre si fuma una canna."
    ...
    new "Ho notato che il costume da bagno di Lisa risulta piuttosto coprente, almeno nella parte anteriore. Non è l’ideale, considerato che la pancia non riesce a prendere il sole. Anche lei sembra pensarla allo stesso modo, ma al momento non ha alternative: gli altri costumi sono andati persi, insieme ad altri effetti personali, durante il trasloco.\nForse potrei cercare un modo per aiutarla, ma per farlo servono soldi..."
