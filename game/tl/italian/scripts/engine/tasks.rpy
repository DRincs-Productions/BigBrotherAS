...
translate italian strings:
    ...
    new "Alice ha parlato del suo blog e anche del problema di aver perso le sue cose durante il trasloco. Ora non ha nulla da mostrare, nulla in cui scrivere sul blog ed è generalmente triste. \nMa per aiutarla in qualche modo con il suo blog, dobbiamo prima ottenere un po' di soldi in più, e non è una soluzione rapida.\nNel frattempo, possiamo lavorare sul nostro rapporto, perché c'è spazio per crescere. L'unica domanda è: come lo facciamo?"
    ...
    new "Convincere Alice a fare webcasting erotico."
