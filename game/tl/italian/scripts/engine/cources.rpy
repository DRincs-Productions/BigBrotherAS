...
translate italian strings:
    ...
    # game/scripts/engine/cources.rpy:47
    ...
    # game/scripts/engine/cources.rpy:49
    old "Обедневшая блогерша"
    new "Blogger impoverito"

    # game/scripts/engine/cources.rpy:110
    old "Массаж ступней"
    ...
    new "Massaggio alle mani"

    # game/scripts/engine/cources.rpy:110
    old "Навыки общения: Чувства человека"
    new "Abilità comunicative: sentimenti umani"
    ...
    new "Questo è un corso sulle abilità comunicative di base che fornisce informazioni di base sui sensi, su come una persona risponde alle tue parole e sulle basi del linguaggio del corpo."
